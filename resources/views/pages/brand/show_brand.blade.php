            ...
            <div class="col-xs-12">
                <div class="pages-title-text text-center">
                    ...
                    <ul class="text-left">
                        ...
                        <li><span> // </span>{{$name->brand_name}}</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <a href="{{URL::to('/chi-tiet/'.$product->product_id)}}"><img src="{{URL::to('public/uploads/product/'.$product->product_image)}}" alt="Product Title" /></a>
